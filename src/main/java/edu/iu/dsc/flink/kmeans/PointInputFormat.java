...
public class PointInputFormat extends FileInputFormat<PointBlock> {
    private static final Logger LOG = LoggerFactory
        .getLogger(PointInputFormat.class);
    ...
    @Override
    public PointBlock nextRecord(PointBlock record) throws IOException {
        PointBlock pointBlock = new PointBlock();
        pointBlock.points = new ArrayList<>();
        while (readLine()) {
