...
//import java.util.*;
//
//public class FlinkBlockBinomialReduction {
...
//                .groupBy(0).reduce(new ReduceFunction<Tuple2<Integer, Point>>() {
//                    @Override
//                    public Tuple2<Integer, Point> reduce(Tuple2<Integer, Point> integerPointTuple2, Tuple2<Integer, Point> t1) throws Exception {
